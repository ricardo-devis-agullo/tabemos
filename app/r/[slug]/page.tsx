...
export default function RecipePage({ params }: { params: Record<string, string> }) {
  const recipe = recipes[String(params.slug)];

  return (
    <div className="flex flex-col items-center">
      <Image width={303} height={228} src={`/photos/${recipe.slug}.jpg`} alt="Photo" />
